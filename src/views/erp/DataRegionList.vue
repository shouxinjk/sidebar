<template>
  <div>
    ...
    <!--字典弹窗-->
    <DataRegionModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="erp-dataRegion" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import DataRegionModal from './components/DataRegionModal.vue';
  import {columns,searchFormSchema} from './DataRegion.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteDataRegion, batchDeleteDataRegion, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './DataRegion.api';
  ...
  async function handleDelete(record) {
    await deleteDataRegion({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteDataRegion({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
