 ...
 */
export const getLeisureSpuInfo = () => {
  return JSON.parse(JSON.stringify(leisureInfoTabs));
}
 ...
 * @returns 包含基本信息、图文详情等tab
 */
export const getLeisureSkuInfo = () => {
  let skuInfo = JSON.stringify(leisureInfoTabs);
...
//酒店SPU查询表单
export const leisureSearchFormSpu: FormSchema = {
  "type": "flex",
  "className": "p-1",
  "items": [
    {
              ...
              "actions": [
                {
                  ...
                  "componentId": "servicespuleisure", // 触发spu数据加载：注意需要触发service，table仅负责显示数据
                  "args":{
                    "&": "$$"
                  }
                }
 ...
 * 列表字段：适用于spu公库、spu私库
 */
export const leisureTableColumns: FormSchema = [
  {
    "label": "服务名称",
    "name": "spu.name",
    "quickEdit": false,
 ...
 */
export const leisureInfoTabs: FormSchema = [
  {
    "title": "基本信息",
    "body": [
      {
