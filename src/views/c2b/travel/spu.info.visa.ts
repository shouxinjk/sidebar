 ...
 */
export const getVisaSpuInfo = () => {
  return JSON.parse(JSON.stringify(visaInfoTabs));
}
 ...
 * @returns 包含基本信息、图文详情等tab
 */
export const getVisaSkuInfo = () => {
  let skuInfo = JSON.stringify(visaInfoTabs);
...
//酒店SPU查询表单
export const visaSearchFormSpu: FormSchema = {
  "type": "flex",
  "className": "p-1",
  "items": [
    {
              ...
              "actions": [
                {
                  ...
                  "componentId": "servicespuvisa", // 触发spu数据加载：注意需要触发service，table仅负责显示数据
                  "args":{
                    "&": "$$"
                  }
                }
 ...
 * 列表字段：适用于spu公库、spu私库
 */
export const visaTableColumns: FormSchema = [
  {
    "label": "服务名称",
    "name": "spu.name",
    "quickEdit": false,
 ...
 */
export const visaInfoTabs: FormSchema = [
  {
    "title": "基本信息",
    "body": [
      {
