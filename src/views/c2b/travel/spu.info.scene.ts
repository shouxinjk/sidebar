 ...
 */
export const getSceneSpuInfo = () => {
  return JSON.parse(JSON.stringify(sceneInfoTabs));
}
 ...
 * @returns 包含基本信息、图文详情等tab
 */
export const getSceneSkuInfo = () => {
  let skuInfo = JSON.stringify(sceneInfoTabs);
...
//酒店SPU查询表单
export const sceneSearchFormSpu: FormSchema = {
  "type": "flex",
  "className": "p-1",
  "items": [
    {
              ...
              "actions": [
                {
                  ...
                  "componentId": "servicespuscene", // 触发spu数据加载：注意需要触发service，table仅负责显示数据
                  "args":{
                    "&": "$$"
                  }
                }
 ...
 * 列表字段：适用于spu公库、spu私库
 */
export const sceneTableColumns: FormSchema = [
  {
    "label": "景点名称",
    "name": "spu.name",
    "quickEdit": false,
 ...
 */
export const sceneInfoTabs: FormSchema = [
  {
    "title": "基本信息",
    "body": [
      {
