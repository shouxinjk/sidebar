 ...
 */
export const getServiceSpuInfo = () => {
  return JSON.parse(JSON.stringify(serviceInfoTabs));
}
 ...
 * @returns 包含基本信息、图文详情等tab
 */
export const getServiceSkuInfo = () => {
  let skuInfo = JSON.stringify(serviceInfoTabs);
...
//酒店SPU查询表单
export const serviceSearchFormSpu: FormSchema = {
  "type": "flex",
  "className": "p-1",
  "items": [
    {
              ...
              "actions": [
                {
                  ...
                  "componentId": "servicespuservice", // 触发spu数据加载：注意需要触发service，table仅负责显示数据
                  "args":{
                    "&": "$$"
                  }
                }
 ...
 * 列表字段：适用于spu公库、spu私库
 */
export const serviceTableColumns: FormSchema = [
  {
    "label": "服务/附加项",
    "name": "spu.name",
    "quickEdit": false,
 ...
 */
export const serviceInfoTabs: FormSchema = [
  {
    "title": "基本信息",
    "body": [
      {
        ...
        "body": [
          ...
          },
          {
            ...
            "name": "spu.props.type",
            "options": [
              "签证服务","单房差","餐厅订位","翻译","旅拍","WIFI租赁","潜水设备"
            ]
          },
          {
            "type": "input-text",
