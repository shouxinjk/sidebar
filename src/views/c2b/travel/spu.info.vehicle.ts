 ...
 */
export const getVehicleSpuInfo = () => {
  return JSON.parse(JSON.stringify(vehicleInfoTabs));
}
 ...
 * @returns 包含基本信息、图文详情等tab
 */
export const getVehicleSkuInfo = () => {
  let skuInfo = JSON.stringify(vehicleInfoTabs);
...
//酒店SPU查询表单
export const vehicleSearchFormSpu: FormSchema = {
  "type": "flex",
  "className": "p-1",
  "items": [
    {
              ...
              "actions": [
                {
                  ...
                  "componentId": "servicespuvehicle", // 触发spu数据加载：注意需要触发service，table仅负责显示数据
                  "args":{
                    "&": "$$"
                  }
                }
 ...
 * 列表字段：适用于spu公库、spu私库
 */
export const vehicleTableColumns: FormSchema = [
  {
    "label": "接驳服务",
    "name": "spu.name",
    "quickEdit": false,
 ...
 */
export const vehicleInfoTabs: FormSchema = [
  {
    "title": "基本信息",
    "body": [
      {
        ...
        "body": [
          ...
          },
          {
            ...
            "name": "spu.props.type",
            "options": [
              "市内接驳","接机","送机","行程跟随","举牌服务"
            ]
          },
          {
            "label": "车辆类型",
            "type": "input-text",
            "name": "spu.props.carType",
          },
          {
            "type": "input-text",
            "label": "目的地/城市",
