...
import {  isDebug,bizAPI, sendAiMsg, sendKbMsg, copyToClipboard, sendRedirect, hookSop, hookAutoReply } from './sidebar.api';
                            ...
                            "actions": [
                              {
                                ...
                                "script": function(e){
                                  ...
                                  ww.sendChatMessage({
                                    msgtype: 'text',
                                    text: {
                                      content: e.props.data.content.replace(/<[^>]+>/g,"")
                                    }
                                  })
                                }
                              },
                                ...
                                "script": function(e){
                                  ...
                                  ww.sendChatMessage({
                                    ...
                                    miniprogram: {
                                      ...
                                      page:"/modules/solution/pages/detail/index.html?id=testid", //小程序消息打开后的路径，注意要以.html作为后缀，否则在微信端打开会提示找不到页面
                                    },
                                  })
                                }
                              },
