<template>
  <a-card :bordered="false" style="height: 100%">
    <div class="j-table-operator" style="width: 100%">
      ...
      <a-button type="primary" preIcon="ant-design:sync-outlined" @click="syncWeworkDepart">同步企微</a-button>
      <!--
...
<script lang="ts" setup>
  ...
  import { Api, deleteBatchDepart, queryDepartTreeSync, syncWeworkDepart} from '../depart.api';
