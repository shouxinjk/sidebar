                ...
                "body": [
                  {
                    "data": {
                      "text": "关于购买价格",
                      "summary": "购买价格指启用该服务的价格，仅在启用服务时消耗一次。",
                      "url": "https://www.biglistoflittlethings.com",
                    },
                    "type": "page",
                  ...
                  },
                  {
                    "data": {
                      "text": "按token计费",
                      "summary": "启用服务后，每次生成内容将根据token数量计算费用消耗，基于虚拟豆计算。 token包括prompt token及生成内容token。",
                      "url": "https://www.biglistoflittlethings.com",
                    },
                    "type": "page",
                    "body": "<div><a href='${url}'>${text}</a></div><div>${summary}</div>"
                  },
                  {
                    "data": {
                      "text": "生成内容存储",
                      "summary": "生成内容不进行存储，可以将生成内容作为客户回复、内容片段等直接使用",
                      "url": "https://www.biglistoflittlethings.com",
                    },
                    "type": "page",
                    "body": "<div><a href='${url}'>${text}</a></div><div>${summary}</div>"
      ...
      "body": [
        ...
        },
        {
          ...
          "api": {
            ...
            "data":{
              "category":"aigc",
              "tenantId": getTenantId(),//指定为当前租户的数据 
              "&":"$$" //传递搜索表单数据
            }
          },
          "body": [
                  ...
                  "items": [
                    {
                      ...
                      "items": {
                        ...
                        "media": {
                          "type": "image",
                          "className": "w-60 h-40",
                          "url": "${service.logo?service.logo:'https://www.biglistoflittlethings.com/static/logo/distributor/ilife.png'}",
                          "position": "top"
                        },
                        "body": [
                          {
                            "type": "tpl",
                            "tpl": "${service.description}",
                            "inline": false,
                            "id": "u:17b9f8e7208d"
                          }
                        ],
