...
import { checkPayResult, createSubscritpionRecord } from '../appstore/apps.api';
  ...
  "body": [
    {
      ...
      "body": [
                      ...
                      "actions": [
                        {
                          ...
                          "componentId": "apps", // 触发sku数据加载：注意需要触发service，table仅负责显示数据
                          "args":{
                            "&": "$$"
                          }
                        }
        ...
        },
        {
          ...
          "api": {
            "method": "get",
            "url": glob.domainUrl + bizAPI.listApps, //仅获取当前租户的app
            "convertKeyToPath": false, //重要：避免自动将key中带有.的键值转换为对象
            "replaceData": true,
            "autoRefresh": true,
            "adaptor": function (payload, response) {
                  ...
                  "items": [
                    {
                      ...
                      "items": {
                        ...
                        "media": {
                          "type": "image",
                          "className": "w-60 h-40",
                          "url": "${software.logo?software.logo:'https://www.biglistoflittlethings.com/static/logo/distributor/ilife.png'}",
                          "position": "top"
                        },
                        "body": [
                          {
                            "type": "tpl",
                            "tpl": "${software.description}",
                            "inline": false,
                            "id": "u:17b9f8e7208d"
                          }
                        ],
