export default {
  ...
  login: {
    ...
    weworkSignInFormTitle: '企业微信',
    qrSignInFormTitle: '二维码登录',
    signUpFormTitle: '注册',
    forgetFormTitle: '重置密码',

    signInTitle: 'iLife确幸定制平台',
    signInDesc: 'iLife确幸定制 = 海量资源 + AI赋能 + 内容生成 + 客户触达，一个人变身公司，公司能力更强效率更高~~',
    policy: '我同意确幸定制隐私政策',
    scanSign: `扫码后，即可完成登录`,
    ...
    weworkLoginFailTitle: '登录失败',
    weworkLoginFailDesc: '请联系管理员开通服务',
